      ...
      <>
        ...
        <div className="paymentContainer">
          ...
          <div className="bkash__box">
            <div
              className="nogod__inline"
              style={{
                width: "40%",
                backgroundColor: "#CB242A",
                marginTop: "2vmax",
                padding: "1vmax",
            ...
            >
              ...
              >
                <img
                  className="nogod__image"
                  src="https://i1.wp.com/ziggasa.com/wp-content/uploads/2020/08/Nagod-Payment-Method.png?fit=1200%2C675&ssl=1"
                  alt="product cover"
                  style={{
                    width: "300px",
                    height: "120px",
